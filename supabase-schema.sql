...
-- Admins (coaches) can read AND edit everyone's profile/plan — so a coach can
-- adjust a member's training and leave coach notes.
...
create policy "admin edit profiles"
...
-- select id, email, true from auth.users where email = 'you@example.com'
